...
# Script de test pour l'exercice 01 : Hello Powercoders
# Usage: ./test_ex01.sh
...
echo -e "${BLUE}=== Test de l'exercice 01 : Hello Powercoders ===${NC}"
...
if [ $EXEC_STATUS -eq 0 ] && [ $TEST_RESULT -eq 0 ]; then
    echo -e "\n${GREEN}✅ Exercice 01 validé avec succès${NC}"
else
    echo -e "\n${RED}❌ Exercice 01 non validé${NC}"
    exit 1
fi
