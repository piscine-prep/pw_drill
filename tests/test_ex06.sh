...
# Script de test pour l'exercice 06 : Addition de deux nombres
# Usage: ./test_ex06.sh
...
echo -e "${BLUE}=== Test de l'exercice 06 : Addition de deux nombres ===${NC}"
...
if [ $EXEC_STATUS -eq 0 ] && [ $TEST_RESULT -eq 0 ]; then
    echo -e "\n${GREEN}✅ Exercice 06 validé avec succès${NC}"
else
    echo -e "\n${RED}❌ Exercice 06 non validé${NC}"
    exit 1
fi
