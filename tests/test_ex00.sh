...
# Script de test pour l'exercice 00 : Afficher la lettre A
# Usage: ./test_ex00.sh
...
echo -e "${BLUE}=== Test de l'exercice 00 : Afficher la lettre A ===${NC}"
...
if [ $EXEC_STATUS -eq 0 ] && [ $TEST_RESULT -eq 0 ]; then
    echo -e "\n${GREEN}✅ Exercice 00 validé avec succès${NC}"
else
    echo -e "\n${RED}❌ Exercice 00 non validé${NC}"
    exit 1
fi
