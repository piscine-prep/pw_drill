...
# Script de test pour l'exercice 09 : Compter de N à 0
# Usage: ./test_ex09.sh
...
echo -e "${BLUE}=== Test de l'exercice 09 : Compter de N à 0 ===${NC}"
...
if [ $EXEC_STATUS -eq 0 ] && [ $TEST_RESULT -eq 0 ]; then
    echo -e "\n${GREEN}✅ Exercice 09 validé avec succès${NC}"
else
    echo -e "\n${RED}❌ Exercice 09 non validé${NC}"
    exit 1
fi
